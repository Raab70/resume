## <i class="fa fa-chevron-right"></i> All Publications <a href="https://github.com/Raab70/resume/blob/master/publications/{{ content.file }}"><i class="fa fa-code-fork" aria-hidden="true"></i></a>
